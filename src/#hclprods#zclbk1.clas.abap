CLASS /hclprods/zclbk1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS /hclprods/zclbk1 IMPLEMENTATION.
    METHOD if_oo_adt_classrun~main.
    DATA:it_bookings TYPE TABLE OF /hclprods/ztbk1.
...
*   Delete the possible entries in the database table - in case it was already filled
    DELETE FROM /hclprods/ztbk1.
*   insert the new table entries
    INSERT /hclprods/ztbk1 FROM TABLE @it_bookings.

*   check the result
    SELECT * FROM /hclprods/ztbk1 INTO TABLE @it_bookings.
*    out->write( sy-dbcnt ).
